...
This tool is currently only able to inform you about any available slot taht meets your criterias. You can monitor a specific time or a time band as wide as you want during the same day.

Once a slot becomes available it is notified to the clients that requested it on a first-come-first-served basis. Meaning the oldest request will take priority over the newest.
We only notify as many clients as slots are available.
...
Pricing
=======
You are billed a fixed amount of £2.99 + VAT for each 24h or fraction during which SlotsOPS will monitor a slot for you.
...
You can also choose to recharge your account's credit via wire transfer to our bank account. For more details please contact accounting@slotsops.com.
...
No affiliation with Geneva airport authority is claimed or implied.
All information provided about PPR availability and service providers in Geneva are of public domain and no priviledged access was used to obtain such information.
